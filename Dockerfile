...
RUN apk add --no-cache flex bc perl bison quilt rsync python3 nasm xz dosfstools mtools ncurses-terminfo-base genext2fs squashfs-tools kmod ncdu linux-headers cpio
